...
function generateStudentReportBrief(params) {
    return __awaiter(this, void 0, void 0, function* () {
        const prompt = `你是心理咨询助理。请用温暖、非诊断的语气，为学生写一段「本次咨询摘要」（80?20 汉字）?

要求? 句话以内；第一句共情；第二句点出主要困扰与情绪；第三句一句可行建议或鼓励求助（若风险偏高须提示联系学校心理中?热线，但不要恐吓）?
