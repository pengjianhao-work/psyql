...
exports.pickCbtModule = pickCbtModule;
exports.scoreCbtCompletion = scoreCbtCompletion;
...
function pickCbtModule(problem, emotion) {
...
function scoreCbtCompletion(module, selections) {
    let adaptiveCount = 0;
    module.steps.forEach((step, idx) => {
        const choiceId = selections[idx];
        const choice = step.choices.find((c) => c.id === choiceId);
        if (choice === null || choice === void 0 ? void 0 : choice.isAdaptive)
            adaptiveCount += 1;
    });
