...
describe('userProfileService', () => {
    ...
    it('aggregates session count and top concerns', () => {
        ...
        (0, historyStore_1.saveDialogToDb)(userId, '考试好焦虑', '回复1', '情绪：焦虑', psych);
        (0, historyStore_1.saveDialogToDb)(userId, '学习压力大', '回复2', '学业压力', Object.assign(Object.assign({}, psych), { problem: 'academic_stress' }));
        (0, historyStore_1.saveDialogToDb)(userId, '和室友相处', '回复3', '人际困扰', Object.assign(Object.assign({}, psych), { problem: 'interpersonal', stressLevel: 55 }));
    ...
    it('includes feedback stats after refresh', () => {
        ...
        const dialogTime = (0, historyStore_1.saveDialogToDb)(userId, 'test', 'reply', 'summary', psych);
