...
exports.cosineSimilarity = exports.preprocessText = void 0;
exports.extractChineseNGrams = extractChineseNGrams;
exports.computeTextRelevance = computeTextRelevance;
exports.expandQueryTerms = expandQueryTerms;
...
function extractChineseNGrams(text, minN = 2, maxN = 4) {
...
function computeTextRelevance(query, targetQuestion, targetAnswer) {
    ...
    const answerGrams = targetAnswer ? new Set(extractChineseNGrams(targetAnswer)) : new Set();
    const questionText = (0, exports.preprocessText)(targetQuestion);
    const answerText = targetAnswer ? (0, exports.preprocessText)(targetAnswer) : '';
    let overlapScore = 0;
...
function buildRetrievalQuery(question, description, extraTerms = []) {
